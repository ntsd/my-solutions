...
X_train, X_valid, Y_train, Y_valid = train_test_split(train, y, test_size = 0.005)
...
file_path = "best_model_gru_cnn.hdf5"
...
def build_model(lr = 0.0, lr_d = 0.0, units = 0, dr = 0.0):
    ...
    history = model.fit(X_train, Y_train, batch_size = 128, epochs = 8, validation_data = (X_valid, Y_valid), 
...
submission.to_csv("bi-gru-cnn-2.csv", index = False)
